...
-- ****** POBLADO DE HISTORIA CLINICA GENERAL
...
(question_text,
 ...
 placeholder)
VALUES
    ("Ortopantomografía", 13, 3, 1, false, "Descripción ortopantomografía"),
    ("Lateral de cráneo", 13, 3, 1, false, "Descripción lateral de cráneo"),
    ("Serie periapical completa", 13, 3, 1, false, "Descripción serie periapical completa"),
    ("Periapical individual", 13, 3, 1, false, "Descripción periapical individual"),
    ("Oclusal superior", 13, 3, 1, false, "Descripción oclusal superior"),
    ("Oclusal inferior", 13, 3, 1, false, "Descripción oclusal inferior"),
    ("Posteroanterior de cráneo (PA)", 13, 3, 1, false, "Descripción posteroanterior de cráneo (PA)"),
    ("Anteroposterior de cráneo (AP)", 13, 3, 1, false, "Descripción anteroposterior de cráneo (AP)"),
    ("Dígito palmar", 13, 3, 1, false, "Descripción dígito palmar"),
    ("Senos paranasales", 13, 3, 1, false, "Descripción senos paranasales"),
    ("Waters de cráneo", 13, 3, 1, false, "Descripción waters de cráneo"),
    ("Submento vertex", 13, 3, 1, false, "Descripción submento vertex"),
    ("Tomografía volumétrica completa", 13, 3, 1, false, "Descripción tomografía volumétrica completa"),
    ("Otros (especifique)", 13, 3, 1, false, "Especifique")
;

-- Modelo de estudio y fotografías
INSERT INTO questions           
(question_text,
 fk_form_section,
 fk_answer_type,
...
-- catalogo de estudiod de laboratorios
Biometria hemática
...
-- considerar catalogo para biopsia
