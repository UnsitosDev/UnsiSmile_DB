...
CREATE TABLE PreguntasAntecedentesHeredofamiliares (
    id_pregunta BIGINT AUTO_INCREMENT PRIMARY KEY,
        pregunta ENUM('Neoplasia (Cáncer)', 'Diabetes', 'Hipertensión Arterial', 'Padecimientos mentales/neurológicos', 'Obesidad', 'Padecimientos hematológicos', 'Malformaciones congénitas', 'Problemas cardiacos') NOT NULL
);

INSERT INTO PreguntasAntecedentesHeredofamiliares (pregunta)
VALUES
    ('Neoplasia (Cáncer)'),
    ('Diabetes'),
...
CREATE TABLE PreguntasCerradasAPPatologicos (
...
INSERT INTO PreguntasCerradasAPPatologicos (pregunta)
VALUES
    ('Tabaquismo'),
    ('Alcoholismo'),
    ('Otras sustancias psicoactivas o recreativas'),
...
CREATE TABLE PreguntasAbiertasAPPatologicos (
...
INSERT INTO PreguntasAbiertasAPPatologicos (pregunta) VALUES
    ('¿Has sido hospitalizado? (en mujeres también anotar datos de parto)'),
    ('Motivo de la hospitalización'),
    ('¿Ha tomado algún medicamento recientemente?'),
    ('¿Cuál es el motivo?'),
...
CREATE TABLE codigo_pieza_dental (
...
CREATE TABLE region_diente (
    id_region INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    descripcion VARCHAR(50)
);

CREATE TABLE diente_detalle (
...
CREATE TABLE RespuestasCerradasNoPatologicos (
...
CREATE TABLE RespuestasAbiertasNoPatologicos (
...
-- Fin de esquemas para consultas
